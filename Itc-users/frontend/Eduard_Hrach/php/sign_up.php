<html>
	...
	<form action="table.php" method="post">
		<p><label id="name_val" for="name">NAME* : </label><input type="text" id="name" placeholder=" YOUR NAME"></input></p>
		<p><label id="lname_val" for="lname">LAST NAME* : </label><input type="text" id="lname" placeholder=" LAST NAME"></input></p>
		<p><label id="mail_val" for="mail">EMAIL* : </label><input type="text" name="mail" id="mail" placeholder=" YOUR EMAIL"></input></p>
		<p><label id="pass_val" for="pass">PASSWORD* : </label><input type="password" id="pass" placeholder=" YOUR PASSWORD"></input></p>
