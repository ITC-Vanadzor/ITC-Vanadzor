...
function valid() {
	...
	err+=1;
	document.getElementById('name_val').style.color= "#FFD700";
	...
	err+=1;
	document.getElementById('lname_val').style.color= "#FFD700";
	...
	err+=1;
	document.getElementById('mail_val').style.color= "#FFD700";
	...
	err+=1;
	document.getElementById('pass_val').style.color= "#FFD700";
