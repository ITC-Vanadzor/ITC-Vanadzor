#!/bin/bash
#Parameters
cards_structure=(HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA HK HQ HJ H10 H9 H8 H7 H6 H5 H4 H3 H2 H1 HA )
...
#Set one argument(array)
Print_matrix(){
	local printed_matrix=${hidden_cards[@]}
	local count
	let count=${#printed_matrix[@]}-1
    for i in `seq 0 $count` 
    do
		echo -n ${printed_matrix[$i]}$'\t'
		let new_row=($i+1)%10
		if [ $new_row -eq 0 ];then
			echo "";
		fi 
    done
	echo "";
