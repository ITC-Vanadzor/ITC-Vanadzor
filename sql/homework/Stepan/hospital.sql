...
--
-- Name: cucak; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.cucak OWNER TO postgres;
...
--
-- Data for Name: cucak; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY cucak (id, doctors_name, clients_name) FROM stdin;
1	Norekyan	Saqanyan
2	Simonyan	not
3	Galoyan	not
4	Simonya	not
5	Petrosyan	Papanyan
6	unknown	fever
7	unknown	stomachache
\.
...
--
-- Name: cucak_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY cucak
    ADD CONSTRAINT cucak_pkey PRIMARY KEY (id);
